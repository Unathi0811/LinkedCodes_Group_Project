					...
					reportSnapshot.docs.map(async (doc) => {
						...
						const locationDescription =
							data.latitude && data.longitude
								? await fetchLocationDescription(
										data.latitude,
										data.longitude
								  )
					...
					if (userDoc.exists()) {
						...
						return {
							...
							profilePhoto:
								...
								"https://via.placeholder.com/60", // Default image if not set
						};
					}
					return {
						userId,
				...
				<View style={styles.reportContainer}>
					...
					<View style={styles.detailsContainer}>
						...
						<View style={styles.iconContainer}>
							<TouchableOpacity
								onPress={() =>
									updateReportStatus(item.id, "In-Progress")
								}
							>
								<Icon4
									name="spinner"
							...
							<TouchableOpacity
								onPress={() =>
									updateReportStatus(item.id, "Completed")
								}
							>
								<Icon4
									name="check-circle"
				...
				<SafeAreaView style={styles.chatContainer}>
					<View style={styles.chatHeader}>
						<Text style={styles.chatTitle}>
							Chat with{" "}
							{userNames[selectedReport?.userId]?.name ||
								"Unknown User"}
						</Text>
