...
const NewsDisplay = () => {
    ...
    useEffect(() => {
      ...
      const handleButton = () => {
        router.push('/component/chatBot/ChatBot')
      }
  ...
  return (
   <View style={{ height:'80%'}}>
     ...
     <TouchableOpacity style={{ position: 'absolute', bottom: 40, right: 20, backgroundColor: '#202A44', borderRadius: 25, padding: 10, elevation: 5,height:50, width:50 }} 
