        ...
        >
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: 15, color: "#EAF1FF" }}>°C</Text>
            </View>

            <Text
              style={{ fontSize: 15, color: "#EAF1FF", marginBottom: "5%" }}
            >
          ...
          >
            ...
            >
              ...
              <Link asChild href="/(userTabs)/home/Forecast">
                <TouchableOpacity>
            ...
            >
              ...
              >
                <Text>
                  {" "}
                  <FontAwesome name="tachometer" size={12} />{" "}
                  {todayWeather.main.pressure} hPa
                </Text>
                <Text>
                  {" "}
                  <FontAwesome name="tint" size={12} />{" "}
                  {todayWeather.main.humidity}%
                </Text>
                <Text>
                  {" "}
                  <MaterialIcons name="air" size={12} />{" "}
              ...
              <View style={{ borderLeftWidth: 1, borderLeftColor: "#202A44" }}>
                ...
                <Text>
                  {" "}
                  <MaterialIcons name="cloud" size={12} />{" "}
                  {todayWeather.clouds.all}%
                </Text>
                <Text>
                  {" "}
                  <MaterialIcons name="water" size={12} />{" "}
