...
const EmergencyContactsScreen = () => {
  ...
  const renderContact = ({ item }) => (
    <View style={styles.contactItem}>
      <TouchableOpacity onPress={() => handleCallPress(item.phone)} style={styles.contactInfo}>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contactUsSection}>
        ...
        <TouchableOpacity onPress={() => handleContactUsPress('facebook')} style={styles.contactUsItem}>
          <MaterialIcons name="facebook" size={24} color="#3b5998" />
          <Text style={styles.contactUsText}> Facebook: Linkedcodes</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => handleContactUsPress('instagram')} style={styles.contactUsItem}>
          <FontAwesome name="instagram" size={24} color="#E1306C" />
          <Text style={styles.contactUsText}> Instagram: Linkedcodes</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => handleContactUsPress('email')} style={styles.contactUsItem}>
