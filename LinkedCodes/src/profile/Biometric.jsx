...
const BiometricSetup = ({ isDarkMode }) => {
    ...
    const toggleBiometricPreference = async () => {
        ...
        // Optionally navigate to another screen after toggling
        if (newValue) {
            // For example, redirect to a confirmation screen or another setup screen
            router.push('/SomeConfirmationScreen'); // Adjust the path as needed
        }
    };
